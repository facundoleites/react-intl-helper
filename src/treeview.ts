...
export class TranslationsProvider
  implements vscode.TreeDataProvider<TranslationFile> {
  private _onDidChangeTreeData: vscode.EventEmitter<
    TranslationFile | undefined | void
  > = new vscode.EventEmitter<TranslationFile | undefined | void>();
  ...
  getChildren(): Thenable<TranslationFile[]> {
    return vscode.window.withProgress(
      ...
      () =>
        new Promise<TranslationFile[]>((resolve, reject) => {
          ...
          const relativePath = configurations.get<string>(
